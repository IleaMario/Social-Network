...
import com.example.socialnetwork.Controller.FriendRequestsController;
...
public class FriendRequestsApplication extends Application {
    ...
    public void initView(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(FriendRequestsApplication.class.getResource("friend-requests-view.fxml"));
